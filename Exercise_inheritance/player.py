...
class BetterComputerPlayer(ComputerPlayer):
    """ A computer tic tac toe player with a slightly more
    sophisticated strategy than ComputerPlayer. """
    def take_turn(self, board):
        """ Claim one of the available squares on the board.
...
class HumanPlayer(Player):
    """ A human tic tac toe player. Looks at the board and makes
    a (hopefully) intelligent decision about where to play.
    """
    def take_turn(self, board):
        """ Claim one of the available squares on the board.
        ...
        while True:
            ...
            try:
                ...
                print("That square is already taken; choose"
                      " another one")
            except ValueError:
